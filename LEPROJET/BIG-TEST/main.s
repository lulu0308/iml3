...
#       afficher_chaine(" 2 : Inserer un nouvel element \n");
        la $a0, ch2
        jal afficher_chaine
#       afficher_chaine(" 3 : Afficher l'arbre dans l'ordre decroissant \n");
        la $a0, ch3
        jal afficher_chaine
#       afficher_chaine(" 4 : Rechercher un element\n");
        la $a0, ch4
        jal afficher_chaine
#       afficher_chaine(" 5 : Afficher la valeur maximale \n");
        la $a0, ch5
        jal afficher_chaine
#       afficher_chaine(" 6 : Supprimer un element ayant la valeur maximale \n");
        la $a0, ch6
        jal afficher_chaine
#       afficher_chaine(" 7 : Afficher la valeur du noeud et supprimer le noeud \n");
        la $a0, ch7
        jal afficher_chaine
...
#                   if (mon_arbre !=NULL)
          beq $s2,$0, elsemain1
#                        afficher_arbre_decroissant(mon_arbre);
        move $a0, $s2
...
#            case 6:
case6:
#                   mon_arbre = supprimer_max(mon_arbre);
        move $a0, $s2
        jal supprimer_max
        move $s2, $v0
#                   break ;
...
case7:
#             case 7:
#                   mon_arbre = afficher_info(mon_arbre);
          move $a0, $s2
